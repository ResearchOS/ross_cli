...
def test_01_add_to_index(temp_index_github_repo_url_only, temp_dir_ross_project, temp_config_path, gh_protocol):  
...
def test_02_add_to_index_after_tap(temp_index_github_repo, temp_dir_ross_project_github_repo, temp_config_path, gh_protocol):
    # Succeeds
...
def test_03_add_to_index_twice(temp_index_github_repo, temp_dir_ross_project_github_repo, temp_config_path, gh_protocol):
